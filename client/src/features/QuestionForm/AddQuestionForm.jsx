                ...
                >
                    <section className='flex gap-x-3 mb-4'>
                        <InputContainer
                            ...
                            className={`text-violet11 shadow-violet7 focus:shadow-violet8 w-full h-full px-[10px] rounded-[4px]  text-[15px] leading-none shadow-[0_0_0_1px] outline-none focus:shadow-[0_0_0_2px]`}
                        />

                        <Select.Root onValueChange={(subjectName) => setFormData({ ...formData, subjectName })}>
                            <Select.Trigger
