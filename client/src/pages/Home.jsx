...
function Home() {
  return (
    <main className='mx-auto  py-4 text-center bg-gray10 max-w-7xl flex flex-col  items-center  rounded-[12px]'>
      <section className='mx-2 p-4 rounded-[12px]   outline outline-violet9 max-w-4xl flex flex-col items-center gap-4 '>
        <h3 className='mx-auto  w-fit mb-2 text-3xl'>
          Welcome to Discussion App!
        </h3>
        <p className='text-justify'>
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Delectus harum reiciendis labore quaerat tenetur nam commodi eum? Quae repellat, voluptatibus laudantium aliquid suscipit enim, id,
          voluptates totam similique labore assumenda.
        </p>
      </section>
